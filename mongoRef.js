...
db.Aug14_1.find({'pT': {$gte: new Date('Sep 1, 2014')}})

// Query for checking if a value exists in an array:
db.Oct14_1.find({'mrv': {'$in': ['22']}})
...
db.coll_name.update({'_id': doc._id}, {'$set': {'mrtIndexed': newTags}});
